...
| Add or update configuration files        | chore                 | 🔧    | [Wrench](https://emojipedia.org/wrench/)                                                     |
| Add or update development scripts        | chore / ci            | 🔨    | [Hammer](https://emojipedia.org/hammer/)                                                     |
| Add a dependency (package.json)          | build                 | ➕    | [Heavy Plus Sign](https://emojipedia.org/plus/)                                              |
| Remove a dependency (package.json)       | build                 | ➖    | [Heavy Minus Sign](https://emojipedia.org/minus/)                                            |
| Upgrade dependencies (package.json)      | build                 | ⬆️    | [Up Arrow](https://emojipedia.org/up-arrow/)                                                 |
| Downgrade dependencies (package.json)    | build                 | ⬇️    | [Down Arrow](https://emojipedia.org/down-arrow/)                                             |
| Pin dependencies to specific versions    | build                 | 📌    | [Pushpin](https://emojipedia.org/pushpin/)                                                   |
...
| Performance                              | perf                  | ⚡️    | [High Voltage](https://emojipedia.org/high-voltage/)                                         |
| Documentation                            | docs                  | 📚    | [Books](https://emojipedia.org/books/)                                                       |
...
| Security Fix                             | fix / build           | 🔒    | [Lock](https://emojipedia.org/lock/)                                                         |
| Critical hotfix                          | fix / build / chore   | 🚑    | [Ambulance](https://emojipedia.org/ambulance/)                                               |
| Add or update code related to validation | feat / fix / ci       | 🦺    | [Safety Vest](https://emojipedia.org/safety-vest/)                                           |
| Add or update CI build system            | ci                    | 👷    | [Construction Worker](https://emojipedia.org/construction-worker/)                           |
...
| Add or update a .gitignore file          | chore                 | 🙈    | [See-No-Evil Monkey](https://emojipedia.org/see-no-evil-monkey/)                             |
| Add or update logs                       | feat / fix / chore    | 🔊    | [Speaker High Volume](https://emojipedia.org/speaker-high-volume/)                           |
| Add or update types                      | refactor              | 🏷️    | [Label](https://emojipedia.org/label/)                                                       |
| Add or update comments in source code    | docs                  | 💡    | [Light Bulb](https://emojipedia.org/light-bulb/)                                             |
| Deprecation                              | \*                    | 💩    | [Pile of Poo](https://emojipedia.org/pile-of-poo/)                                           |
| Initial Commit                           | chore                 | 🎉    | [Party Popper](https://emojipedia.org/party-popper/)                                         |
...
| Merge commit in `main`                              | 🚀    | [Rocket](https://emojipedia.org/rocket/)                               |
| Commit with breaking change                         | 💥    | [Collision](https://emojipedia.org/collision/)                         |
| Commit in code review (to be squashed before merge) | 🏓    | [Ping Pong](https://emojipedia.org/ping-pong/)                         |
