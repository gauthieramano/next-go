  ...
  return (
    <article className="group relative">
      <div className="relative mb-8 aspect-video overflow-hidden rounded-sm">
        ...
        {blog.tags && (
          <Link
            ...
            className="absolute top-5 left-5 z-10 rounded-sm bg-primary px-4 py-[6px] font-heading font-medium text-sm text-white"
          >
            {blog?.tags[0]}
          </Link>
        )}
      ...
      <dl className="mb-4 flex items-center gap-5">
        <dt className="flex items-center gap-2 font-heading text-base text-dark-text">
      ...
      <h3>
        <Link
          ...
          className="hover:!text-primary line-clamp-2 font-heading font-medium text-dark text-xl md:text-2xl lg:text-xl xl:text-2xl dark:text-white"
        >
