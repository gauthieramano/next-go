  ...
  return (
    <section id="cta" className="pt-14 sm:pt-20 lg:pt-[130px]">
      <div className="px-4 xl:container">
        <div className="relative overflow-hidden bg-center bg-cover px-10 py-[60px] drop-shadow-light sm:px-[70px] dark:drop-shadow-none">
          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-2/3">
              <div className="mx-auto mb-10 max-w-[550px] text-center lg:mb-0 lg:ml-0 lg:text-left">
                <h2 className="mb-4 font-heading font-semibold text-dark text-xl leading-tight sm:text-[38px] dark:text-white">
